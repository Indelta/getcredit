...
class DynamicImport extends Component {
    ...
    render() { return this.props.children(this.state.component); }
}

const MainPage = (props) => {
    return <DynamicImport load={() => import('./MainPage')}>
        {Component => Component === null ? <Loading /> : <Component { ...props } />}
    </DynamicImport>
}
const Faq = props => {
    return <DynamicImport load={() => import('./Faq')}>
        { Component => Component === null ? <Loading /> : <Component {...props} /> }
    </DynamicImport>
}
const AboutUs = props => {
    return <DynamicImport load={() => import('./AboutUs')}>
        {Component => Component === null ? <Loading /> : <Component {...props} />}
    </DynamicImport>
}
const Contacts = props => {
    return <DynamicImport load={() => import('./Contacts')}>
        {Component => Component === null ? <Loading /> : <Component {...props} />}
    </DynamicImport>
}
const Calculator = props => {
    return <DynamicImport load={() => import('./Calculator')}>
        {Component => Component === null ? <Loading /> : <Component {...props} />}
    </DynamicImport>
}
const ForBusiness = props => {
    return <DynamicImport load={() => import('./ForBusiness')}>
        {Component => Component === null ? <Loading /> : <Component {...props} />}
    </DynamicImport>
}
const Admin = props => {
    return <DynamicImport load={() => import('./Admin')}>
        {Component => Component === null ? <Loading /> : <Component {...props} />}
    </DynamicImport>
}
const Policy = props => {
    return <DynamicImport load={() => import('../components/Policy')}>
        {Component => Component === null ? <Loading /> : <Component {...props} />}
    </DynamicImport>
}
const ProcessingRules = props => {
    return <DynamicImport load={() => import('../components/ProcessingRules')}>
        {Component => Component === null ? <Loading /> : <Component {...props} />}
    </DynamicImport>
}
const Posts = props => {
    return <DynamicImport load={() => import('./Posts')}>
        {Component => Component === null ? <Loading /> : <Component {...props} />}
    </DynamicImport>
}
const Consultation = props => {
    return <DynamicImport load={() => import('./Consultation')}>
        {Component => Component === null ? <Loading /> : <Component {...props} />}
    </DynamicImport>
}
const NotFound = props => {
    return <DynamicImport load={() => import('./404')}>
        { (Component) => Component === null ? <Loading /> : <Component {...props} />}
    </DynamicImport>
}
...
class App extends Component {
    ...
    getUtms() {
        ...
        return {utm_term, utm_source, utm_medium, utm_campaign, utm_content, superseller};
    }
    render() {
        return (
            <Router>
